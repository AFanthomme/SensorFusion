...
all_conditions_names = ['minimal_model/all_losses/', 'minimal_model/no_fb_losses/', 'offshelf_LSTM/pretrained/', 'offshelf_LSTM/pretrained_frozen/', 'offshelf_LSTM/use_start_rep_no_pretrain/', 'offshelf_LSTM/pretrained_no_start_rep/']
