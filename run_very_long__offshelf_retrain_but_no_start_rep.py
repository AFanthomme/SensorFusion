...
class retrain_offshelf_no_start_rep:
    def __init__(self):
        pass
    ...
    def __call__(self, seed):
        ...
        for image_availability in image_availabilities:
            for reinference_error in reinference_errors:
                ...
                params['net_params']['options']['use_start_rep_explicitly'] = False
                ...
                params['net_params']['options']['save_folder'] = PATH + 'long_experiment/offshelf_LSTM/pretrained_no_start_rep/error_{}_avail_{}/'.format(reinference_error, image_availability)
...
if __name__ == '__main__':
    ...
    pool.map(retrain_offshelf_no_start_rep(), range(start_seed, start_seed+n_seeds))
