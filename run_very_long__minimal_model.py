    ...
    def __call__(self, seed):
        ...
        for reinference_error in reinference_errors:
            for image_availability in image_availabilities:
                ...
                params['net_params']['options']['save_folder'] = PATH + 'long_experiment/minimal_model/all_losses/error_{}_avail_{}/'.format(reinference_error, image_availability)
...
if __name__ == '__main__':
    ...
    pool.map(train_minimal_model(), range(start_seed, start_seed+n_seeds))
