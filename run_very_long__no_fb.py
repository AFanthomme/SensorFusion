...
class train_minimal_model_no_fb_losses:
    def __init__(self):
        pass
    ...
    def __call__(self, seed):
        ...
        for image_availability in image_availabilities:
            for reinference_error in reinference_errors:
                ...
                params['net_params']['options']['save_folder'] = PATH + 'long_experiment/minimal_model/no_fb_losses/error_{}_avail_{}/'.format(reinference_error, image_availability)
...
if __name__ == '__main__':
    ...
    pool.map(train_minimal_model_no_fb_losses(), range(start_seed, start_seed+n_seeds))
