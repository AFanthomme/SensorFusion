...
class FixedRewardWorld(gym.Env):
    ...
    def __init__(self, map_name='SnakePath', scale=.5, reward_area_width = .3, objects_layout_name='Default', chosen_reward_pos='Default', epoch_len=20, seed=0, load_preprocessor_from=None):
        ...
        self.reward_room = env_params['possible_reward_pos'][chosen_reward_pos]['room']
        self.reward_pos = np.array(env_params['possible_reward_pos'][chosen_reward_pos]['pos']) * self.scale
    ...
    def get_observation(self, room, position):
        ...
        # all_positions = (self.positions_blob[rooms] - positions[:, np.newaxis, :].repeat(self.max_objects_per_room, axis=1)).astype(np.float32)
...
class GoalBasedWorld(gym.GoalEnv):
    # def __init__(self, map_name='SnakePath', scale=.5, reward_area_width = .3, objects_layout_name='Default', chosen_reward_pos='TopRight', epoch_len=20, seed=0, load_preprocessor_from=None):
    def __init__(self, map_name='SnakePath', scale=.5, reward_area_width = .3, objects_layout_name='Default', epoch_len=20, seed=0, load_preprocessor_from=None):
...
if __name__ == '__main__':
    ...
    for chosen_reward_pos in ['Default', 'TopRight']:
