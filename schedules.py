...
class DefaultSchedulerLR:
    def __init__(self, **kwargs):
        ...
        self.current_lr = [1e-3, 1e-3, 1e-3, 1e-3, 1e-4]
...
class DefaultSchedulerWeights:
    def __init__(self, **kwargs):
        self.current_weights = [10, 10, 10, 1, 0, 0]
...
class AnnealedSchedulerLR:
    def __init__(self, **kwargs):
        self.current_lr = [5e-4, 1e-3, 1e-3, 1e-3, 1e-3,]
        self.switch_at = [2000, 4000, 6000, 2**20]
        self.idx = 0

        self.lr_to_switch_to = [
            [5e-4, 5e-4, 5e-4, 5e-4, 5e-4],
            [1e-4, 5e-4, 5e-4, 5e-4, 5e-4],
            [1e-4, 1e-4, 1e-4, 1e-4, 0],
            None
        ]
...
class AlternatingSchedulerWeights:
    def __init__(self, **kwargs):
        self.current_weights = [1, 1, 1, 0, 0, 0]
