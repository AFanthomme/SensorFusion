    ...
    def __call__(self, seed):
        ...
        for image_availability in image_availabilities:
            for reinference_error in reinference_errors:
                ...
                params['net_params']['options']['save_folder'] = PATH + 'long_experiment/offshelf_LSTM/use_start_rep_no_pretrain/error_{}_avail_{}/'.format(reinference_error, image_availability)
