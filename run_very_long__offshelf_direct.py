...
image_availabilities = [0., .2, .5, 1.]


class train_offshelf_direct:
    def __init__(self):
        pass
    ...
    def __call__(self, seed):
        ...
        for reinference_error in reinference_errors:
            for image_availability in image_availabilities:
                ...
                params['net_params']['options']['save_folder'] = PATH + 'long_experiment/offshelf_LSTM/end_to_end/error_{}_avail_{}/'.format(reinference_error, image_availability)
...
if __name__ == '__main__':
    ...
    pool.map(train_offshelf_direct(), range(start_seed, start_seed+n_seeds))
