...
for env_name, load_from, use_recurrence, details_name, im_availability in zip(["MultiGoalSnakePath-v1"], ['out/SnakePath_Default/end_to_end/default/'], [True], ['rec_images_unreliable_far_west'], [.5]):
    SEED=0
    ...
    method = 'TD3'
    EVAL_EVERY=5000
    TENSORBOARD_LOG_FOLDER = "./logs/far_west/tensorboard/"
    ...
    checkpoint_callback = CheckpointCallback(save_freq=EVAL_EVERY, save_path="./logs/far_west/saves/".format(env_name, details_name, method, SEED))
    ...
    model.save("/logs/far_west/tensorboard/best_net.tch")
